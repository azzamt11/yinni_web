...
export default function HomeProduct() {
  ...
  async function fetchPackages(p = 1) {
    ...
    try {
      ...
      console.log(`fetching: ${ENDPOINTS.list}?${params.toString()}`);
  ...
  // Chakra Color Mode
  const textColorBrand = useColorModeValue("gray.400", "gray.400");
  const textColorBrandActivated = useColorModeValue("brand.500", "white");
    ...
    <Box pt={{ base: "150px", md: "50px", xl: "50px" }}>
      ...
      <Grid
        ...
        <Flex
          ...
          gridArea={{ xl: "1 / 1 / 1 / 4", "2xl": "1 / 1 / 2 / 3" }}>
          <Flex direction='column'>
            <Flex
              ...
              <Flex
                ...
                mt={{ base: "20px", md: "0px" }}>
                <Link
                  color={categoryFilter == "" ? textColorBrandActivated : textColorBrand}
                  fontWeight='500'
                ...
                <Link
                  color={categoryFilter == "Haji" ? textColorBrandActivated : textColorBrand}
                  fontWeight='500'
                  me={{ base: "34px", md: "44px" }}
                  onClick={() => {setCategoryFilter("Haji")}}
                  to='#haji'>
                  Haji
                </Link>
                <Link
                  color={categoryFilter == "Umroh" ? textColorBrandActivated : textColorBrand}
                  fontWeight='500'
                  me={{ base: "34px", md: "44px" }}
                  onClick={() => {setCategoryFilter("Umroh")}}
                  to='#umroh'>
                  Umroh
                </Link>
                <Link
                  color={categoryFilter == "Internasional" ? textColorBrandActivated : textColorBrand}
                  fontWeight='500'
                  me={{ base: "34px", md: "44px" }}
                  onClick={() => {setCategoryFilter("Internasional")}}
                  to='#international'>
                  Internasional
                </Link>
                <Link
                  color={categoryFilter == "Domestik" ? textColorBrandActivated : textColorBrand}
                  fontWeight='500'
                  me={{ base: "34px", md: "44px" }}
                  onClick={() => {setCategoryFilter("Domestik")}}
                  to='#domestic'>
                  Domestik
                </Link>
              </Flex>
            ...
            <SimpleGrid columns={{ base: 1, md: 3, lg: 4 }} gap='20px'>
              {items.map((pkg) => (
                <Box key={pkg.ID}>
                  <HomeNFT
                    name={pkg.name}
                  ...
                  <FormControl mt={4}>
                      ...
                      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={2}>
                          ...
                          <Checkbox 
                            ...
                            onChange={(e) => setField("includeSTranslator", e.target.checked)}
                          >
                            Penerjemah
                          </Checkbox>
                          <Checkbox 
